...
public class Game extends Application {
	...
	public void start ( Stage stage ) throws Exception {
		AudioInputStream audioIn = AudioSystem.getAudioInputStream ( getClass ( ).getResource ( "/Sound/music" +
                     ".wav" ) );
		...
		init ( );
		new AnimationTimer ( ) { // main game loop, constantly runs update(update) and draw (render) to show
